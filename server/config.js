...
module.exports =
{
	...
	https  :
	{
		...
		tls        :
		{
			cert : process.env.HTTPS_CERT_FULLCHAIN || `D:/Workspace/server/certs/s183.lsinternal.com.crt`,
			key  : process.env.HTTPS_CERT_PRIVKEY || `D:/Workspace/server/certs/s183.lsinternal.com.key`
		}
	},
	// mediasoup settings.
	mediasoup :
	{
		...
		webRtcTransportOptions :
		{
			...
			[
				{
					ip          : process.env.MEDIASOUP_LISTEN_IP || '192.168.1.183',
